    ...
    <div class="w-1/2 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-gray-100 border-r z-30 fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform lg:translate-x-0 lg:static lg:inset-0" id="main-nav">
          ...
          <div class="mb-4 px-4">
            ...
            <div class="w-full flex items-center text-blue-400 h-10 pl-4 bg-gray-200 hover:bg-gray-200 rounded-lg cursor-pointer">
              ...
              <span class="text-gray-700"><RouterLink to="/dashboard">Dashboard</RouterLink></span>
            </div>
            ...
            <div class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
              ...
              <span class="text-gray-700">Kho sách</span>
            </div>
            <div class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
              <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
          ...
          <div class="mb-4 px-4">
            ...
            <div class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
              ...
              <span class="text-gray-700"><RouterLink to ='/addproduct'>Add Product</RouterLink></span>
            </div>
            <div class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
              <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
              ...
              <span class="text-gray-700"><RouterLink to ='/viewproduct'>View Products</RouterLink></span>
            </div>
          </div>
          ...
          <div class="mb-4 px-4">
            ...
            <div class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
              ...
              <span class="text-gray-700">Thông báo đơn hàng</span>
            </div>
          </div>
