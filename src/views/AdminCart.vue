...
<header class="flex items-center justify-between px-6 py-4 bg-white border-b-4 border-indigo-600">
                ...
                <div class="container px-6 py-8 mx-auto">
                    <h3 class="text-3xl font-medium text-gray-700">Giỏ hàng</h3>
                    ...
                    <CartList :cartLists="this.cartperPage" />
                    <Pagination 
...
export default{
    ...
    methods:{
        ...
        async RetrieveCartPerPage(page){
            this.cartperPage = await cartService.getByPage(this.pageValue)
        },
        getPageSize(){
            return Math.ceil(this.carts.length/5)
        },
        async updatePageValue(data){
            this.cartperPage = await cartService.getByPage(data);
        },
        cartsnumber(){
