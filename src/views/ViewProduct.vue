        ...
        <div class="flex flex-col flex-1 overflow-hidden">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                <div class="container px-6 py-8 mx-auto">
                    ...
                    <Product :productLists="this.productsPerPage"/>
                    <Pagination 
...
export default{
    ...
    computed:{
            contactStrings() {
                return this.tmp.map((product) => {
                    const { productname, author,category } = product;
                    return [productname, author,category].join("");
                });
            },
    ...
    methods:{
        ...
        filteredContacts() {
            ...
            if (!this.searchText) this.productsPerPage = this.tmp
                this.productsPerPage = this.tmp.filter((_product, index) =>
                this.contactStrings[index].includes(this.searchText)
            );
        },
        async updatePageValue(data){
            this.productsPerPage = await productService.getByPage(data)
            this.tmp =await productService.getByPage(data)
        },
        getPageSize(){
